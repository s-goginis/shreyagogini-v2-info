...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#050002' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#050002',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#050002',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#050002',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #05000230 0%, #fff 0%)`,
})
